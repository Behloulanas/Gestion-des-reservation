    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(88, 88, 88)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Logintxt, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          try {
            ...
            String req5="select * from user";
            PreparedStatement stmt=connexion.getCon().prepareStatement(req5);
            ResultSet rs=stmt.executeQuery();
            while(rs.next()) {
                if(Logintxt.getText().equals(rs.getString(2)) && Passwordtxt.getText().equals(rs.getString(3))){
                    ...
                    JOptionPane.showMessageDialog(this,"Ressayer");
                }
            }
